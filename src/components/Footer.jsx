      ...
      <div className="max-w-7xl mx-auto px-6 py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10">
          ...
          <div className="space-y-4 lg:col-span-1">
            ...
            {/* Social Links (Safe Inline SVGs) */}
            <div className="flex items-center gap-3 pt-2 text-gray-600 dark:text-gray-400">
              {/* GitHub */}
              <a
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-gray-600 dark:text-gray-400">
              <li className="flex items-center gap-2.5">
                ...
                <a href="mailto:support@orange.ai" className="hover:text-black dark:hover:text-white transition">
                  support@jabedhosen
                </a>
              </li>
              <li className="flex items-center gap-2.5">
                <Phone className="w-4 h-4 text-purple-500 shrink-0" />
                <span>+01827905475</span>
              </li>
              <li className="flex items-start gap-2.5">
                <MapPin className="w-4 h-4 text-purple-500 shrink-0 mt-0.5" />
                <span>Cokbazar,Chittagong</span>
              </li>
            </ul>
          </div>
